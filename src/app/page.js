  ...
  return (
    <section className="bg-[#971313] h-screen grid lg:grid-cols-2 grid-cols-1 justify-items-center items-center">
      ...
      <div className="order-1 lg:order-2">
        <Image className="animate-[flying_4s_ease-in-out_infinite]" src="programming.svg" width={500} height={500} alt="Web Developer"></Image>
      </div>
    </section>
  )
}
...
function Main(params) {
  return (
    <main id="main" className="lg:p-12 p-6">
      ...
      <section id="jenis">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 mt-6">
          <div className="p-6 bg-[#971313] text-center text-white">
            ...
            <div>
              <Image className="inline mx-2" width={50} height={50} src="html.svg"/>
              <Image className="inline mx-2" width={50} height={50} src="css.svg"/>
              <Image className="inline mx-2" width={50} height={50} src="js.svg"/>
            </div>
          </div>
          <div className="p-6 bg-[#971313] text-center text-white">
            ...
            <div>
              <Image className="inline mx-2" width={50} height={50} src="java.svg"/>
              <Image className="inline mx-2" width={50} height={50} src="python.svg"/>
              <Image className="inline mx-2" width={50} height={50} src="php.svg"/>
            </div>
          </div>
          <div className="p-6 bg-[#971313] text-center text-white">
